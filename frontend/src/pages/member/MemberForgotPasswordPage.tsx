...
const MemberForgotPasswordPage: React.FC = () => {
    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-50 dark:bg-gray-900 p-4">
      <Card className="w-full max-w-md p-8">
        ...
        <div className="mt-6 text-center">
          <Link to="/portal/login" className="text-sm text-aidatim-blue dark:text-aidatim-blue hover:underline flex items-center justify-center gap-1">
            <ArrowLeft size={16} />
            Terug naar inloggen
          </Link>
        </div>
