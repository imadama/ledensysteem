...
- 🔍 **AUDIT-33 · MEDIUM · Organisatie-verwijdering laat live Stripe-subscriptions achter** (niet geverifieerd — nog uitzoeken/opschonen bij org-delete).
- 🔍 **AUDIT-34 · MEDIUM · Geseede `platform_admin` met zwak default-wachtwoord** (niet geverifieerd — seeder controleren).
